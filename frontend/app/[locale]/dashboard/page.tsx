      ...
      <section className="w-full px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div
                  ...
                  className={`transition-all duration-500 ${
                    isActive
                      ...
                      : "opacity-30 scale-95 grayscale print:hidden"
                  }`}
                >
                  <MetricsCard
                    label={d(key)}
        ...
        <div className="hidden print:block pt-8 border-t border-gray-200">
          <h2 className="text-xl font-bold mb-4">
            Monthly Event Summary ({currentViewYear})
          </h2>
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-50">
                ...
                {trendData.map((d) => (
                  <th key={d.name} className="border p-2 text-center text-xs">
                    {d.name}
                  </th>
                ))}
              </tr>
            ...
            <tbody>
              <tr>
                ...
                {trendData.map((d) => (
                  <td key={d.name} className="border p-2 text-center">
                    {d.value}
                  </td>
                ))}
              </tr>
